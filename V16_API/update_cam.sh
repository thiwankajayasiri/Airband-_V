...
gst-launch-1.0 -v imxv4l2videosrc device=/dev/video0 ! imxvpuenc_h264 bitrate=500 ! rtph264pay config-interval=10 ! udpsink host=235.18.20.11 auto-multicast=true port=9722 ttl=8 ttl-mc=8 sync=false > /root/gst.log 2>&1 & 
